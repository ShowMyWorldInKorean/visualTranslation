...
def run_command_eng_hin(i, n):
    os.system(f"python render_Indian_language_scenetext.py utils/eng_hin.txt utils/Hin_Uniq_RS.txt ./dataset/o{i} {n}")

def run_command_hin_eng(i, n):
    os.system(f"python render_Indian_language_scenetext.py utils/hin_eng.txt utils/Hin_Uniq_RS.txt ./dataset/o{i} {n}")
