...
natural_bg_list = glob.glob("utils/background_images/natural_scenes/*")
plain_bg_list =glob.glob("utils/background_images/plain_colors/*")

print('number of natural background images= ', len(natural_bg_list))
print('number of plain background images= ', len(plain_bg_list))
...
for i in tqdm(range(0, num_samples), desc='Completed generations'):
    try:
        ...
        chosen_background_type = np.random.choice(background_type, 1, p=background_prob).item()
        ...
        grayImageName = 'utils/plain_colors/1280x800-roman-silver-solid-color-background.jpg'
        blackImageName = 'utils/plain_colors/1280x800-black-solid-color-background.jpg'
